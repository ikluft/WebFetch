...
my @items_revchron;
{
    ...
    @items_revchron = sort WebFetch::Output::Capture::sort_items_revchron @items_unsorted;
...
foreach my $item (@items_revchron) {
    ...
    print "    <a href=\"".$item->[$link_num]."\">".$item->[$title_num]."</a> released by ".$item->[$creator_num]."\n";
    print "\n";
}
