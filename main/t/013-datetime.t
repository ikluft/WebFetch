...
Readonly::Array my @tests => (
    {
        ...
        tz => [''], timestr => "2022-08-05",
        check => {year => 2022, month => 8, day => 5, hour => undef, minute => undef, second => undef,
            time_zone => undef, anchor => "2022-08-05"},
    },
    {
        # date only, multiple time zones
        tz => [qw(PST8PDT US/Pacific America/Los_Angeles)], locale => "en-US", timestr => "2022-08-05",
        check => {year => 2022, month => 8, day => 5, hour => undef, minute => undef, second => undef,
            time_zone => undef, anchor => "2022-08-05"},
    },
    {
        # full date/time, no time zone/locale
        tz => [''], timestr => "2022-08-05T19:30:00",
        check => {year => 2022, month => 8, day => 5, hour => 19, minute => 30, second => 0,
            time_zone => "floating", anchor => "2022-08-05-19-30-00"},
    },
    {
        # full date/time, multiple time zones (west) from floating time
        tz => [qw(PST8PDT US/Pacific America/Los_Angeles)], locale => "en-US", timestr => "2022-08-05T19:30:00",
        check => {year => 2022, month => 8, day => 5, hour => 19, minute => 30, second => 0,
            time_zone => "floating", anchor => "2022-08-05-19-30-00"},
    },
    {
        # full date/time, multiple time zones (west) from UTC
        tz => [qw(PST8PDT US/Pacific America/Los_Angeles)], locale => "en-US", timestr => "2022-08-05T19:30:00+00:00",
        check => {year => 2022, month => 8, day => 5, hour => 19, minute => 30, second => 0,
            time_zone => "UTC", anchor => "2022-08-05-19-30-00"},
    },
    {
        # full date/time, one time zone (east) from floating time
        tz => [qw(Australia/Sydney)], locale => "en-AU", timestr => "2022-08-05T19:30:00",
        check => {year => 2022, month => 8, day => 5, hour => 19, minute => 30, second => 0,
            time_zone => "floating", anchor => "2022-08-05-19-30-00"},
    },
    {
        # full date/time, one time zone (east) from UTC
        tz => [qw(Australia/Sydney)], locale => "en-AU", timestr => "2022-08-05T19:30:00+00:00",
        check => {year => 2022, month => 8, day => 5, hour => 19, minute => 30, second => 0,
            time_zone => "UTC", anchor => "2022-08-05-19-30-00"},
    },
);
